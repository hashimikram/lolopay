...
public class PayInExecutionDetailsWeb extends Dto implements PayInExecutionDetails {
  ...
  /**
   * The URL where you host the iFramed template. For CB, Visa, MasterCard you need to specify
   * PAYLINE: before your URL with the iFramed template ex: PAYLINE:
   * https://www.maysite.com/payline_template/ Used for: - direct debit web type pay-in.
   *
   * @deprecated Use {@link #getTemplateURLOptions()} and {@link
   *     #setTemplateURLOptions(PayInTemplateURLOptions)} instead.
   */
  @Deprecated public PayInTemplateURLOptions TemplateURLOptions;
