...
public class PayInPaymentDetailsCard extends Dto implements PayInPaymentDetails {
  ...
  public static PayInPaymentDetailsCard build(
      CardType cardType, String cardId, String statementDescriptor) {
    return new PayInPaymentDetailsCard(cardType, cardId, statementDescriptor);
  }

  public static PayInPaymentDetailsCard convert(PayInPaymentDetails paymentDetails)
      throws Exception {
