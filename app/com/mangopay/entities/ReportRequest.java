...
public class ReportRequest extends EntityBase {
  ...
  /**
   * Columns to be included in the report. Allowed values: "Alias", "BankAccountId", "BankWireRef",
   * "CardId", "CardType", "Country", "Culture", "Currency", "DeclaredDebitedFundsAmount",
   * "DeclaredDebitedFundsCurrency", "DeclaredFeesAmount", "DeclaredFeesCurrency", "ExecutionType",
   * "ExpirationDate", "PaymentType", "PreauthorizationId", "WireReference".
   */
