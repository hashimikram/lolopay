...
public class Mandate extends EntityBase {
  ...
  /**
   * The bank account ID to associate this mandate against (and hence from where the payins will
   * come from).
   */
  ...
  /**
   * The type of mandate – it will be SEPA or BACS but will only be completed once the mandate has
   * been submitted.
   */
  ...
  /**
   * The URL where you must redirect the user for them to confirm the setup of their mandate and
   * then he will be redirected to the ReturnURL.
   */
  ...
  /**
   * The status of the mandate: CREATED (the mandate has been created), SUBMITTED (the mandate has
   * been submitted to the banks and you can now do payments with this mandate), ACTIVE (the mandate
   * is active and has been accepted by the banks and/or successfully used in a payment), FAILED
