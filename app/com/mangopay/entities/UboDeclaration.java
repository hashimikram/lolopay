...
public class UboDeclaration extends EntityBase {
  ...
  /**
   * Listed representations of natural users declared as UBOs. When transmitting a UBO declaration
   * (POST / PUT), must be an array of IDs (string) of the users to be declared as UBOs. In a
   * received UBO declaration (GET), will be an array of representations of the natural users
   * declared as UBOs.
   */
  @SerializedName("Ubos")
