...
public class Repudiation extends EntityBase {
  ...
  /**
   * The amount of credited funds – since there are currently no fees, this will be equal to the
   * DebitedFunds.
   */
  ...
  /**
   * The Id of the dispute to which this repudiation corresponds. Note that this value may be null
   * (if it was created before the Dispute objects started to be used – October 2015).
   */
