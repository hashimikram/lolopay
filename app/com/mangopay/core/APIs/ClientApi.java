...
public interface ClientApi {
  ...
  List<KycDocument> getKycDocuments(Pagination pagination, FilterKycDocuments filter, Sorting sort)
      throws Exception;
  ...
  /**
   * Upload a logo for client. Only GIF, PNG, JPG, JPEG, BMP, PDF and DOC formats are accepted, and
   * file must be less than about 7MB.
   *
  ...
  /**
   * View your client wallets. To see your fees or credit wallets for each currency set the {@code
   * fundsType} parameter.
   *
   ...
   * @throws Exception
   */
  List<Transaction> getWalletTransactions(
      FundsType fundsType,
   ...
   * @throws Exception
   */
  List<Transaction> getTransactions(Pagination pagination, FilterTransactions filter, Sorting sort)
      throws Exception;
   ...
   *
   * <ul>
   *   <li>Call the /payins/bankwire/direct object. You’ll receive MANGOPAY bank account details and
   *       a reference.
   *   <li>Display this information to your user
   *   <li>The user has to proceed a Bank wire to the display bank account with the reference
   *   <li>Once MANGOPAY receive the payment the e-money is created and the targeted e-wallet is
   *       credited
   * </ul>
   *
   ...
   * @throws Exception
   */
  PayIn createBankWireDirect(String idempotencyKey, ClientBankWireDirect bankWireDirect)
      throws Exception;
}
