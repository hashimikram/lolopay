...
public interface CardApi {
  ...
  /**
   * Gets a list of cards having the same fingerprint. The fingerprint is a hash uniquely generated
   * per 16-digit card number.
   *
   ...
   * @throws Exception
   */
  List<Transaction> getTransactions(String cardId, Pagination pagination, Sorting sorting)
      throws Exception;
