...
public interface MandateApi {
   ...
   * @throws Exception
   */
  List<Mandate> getAll(FilterMandates filters, Pagination pagination, Sorting sorting)
      throws Exception;
   ...
   * @throws Exception
   */
  List<Mandate> getForBankAccount(
      String userId,
   ...
   * @throws Exception
   */
  List<Transfer> getTransfers(String mandateId, Pagination pagination, Sorting sorting)
      throws Exception;
}
