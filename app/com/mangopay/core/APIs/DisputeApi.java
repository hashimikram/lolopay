...
public interface DisputeApi {
   ...
   * @throws Exception
   */
  List<Dispute> getAll(Pagination pagination, FilterDisputes filters, Sorting sorting)
      throws Exception;
   ...
   * @throws Exception
   */
  List<Dispute> getDisputesForWallet(
   ...
   * @throws Exception
   */
  List<Dispute> getDisputesForUser(
   ...
   * @throws Exception
   */
  List<DisputeDocument> getDocumentsForDispute(
   ...
   * @throws Exception
   */
  List<DisputeDocument> getDocumentsForClient(
   ...
   * @throws Exception
   */
  Transfer createSettlementTransfer(SettlementTransfer settlementTransfer, String repudiationId)
      throws Exception;
   ...
   * @throws Exception
   */
  Transfer createSettlementTransfer(
   ...
   * @throws Exception
   */
  List<Dispute> getDisputesWithPendingSettlement(Pagination pagination, Sorting sorting)
      throws Exception;
   ...
   * @throws Exception
   */
  DisputeDocument submitDisputeDocument(DisputeDocument disputeDocument, String disputeId)
      throws Exception;
   ...
   * @throws Exception
   */
  DisputeDocument createDisputeDocument(DisputeDocument disputeDocument, String disputeId)
      throws Exception;
   ...
   */
  void createDisputePage(
      String idempotencyKey, String disputeId, String documentId, String filePath) throws Exception;
