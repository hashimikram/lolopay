...
public class CardPreAuthorizationApiImpl extends ApiBase implements CardPreAuthorizationApi {
  ...
  @Override
  public CardPreAuthorization create(
      String idempotencyKey, CardPreAuthorization cardPreAuthorization) throws Exception {
  ...
  public CardPreAuthorization get(String cardPreAuthorizationId) throws Exception {
    return this.getObject(
        CardPreAuthorization.class, "preauthorization_get", cardPreAuthorizationId);
  }

  @Override
  public CardPreAuthorization update(CardPreAuthorization cardPreAuthorization) throws Exception {
    return this.updateObject(
        CardPreAuthorization.class, "preauthorization_save", cardPreAuthorization);
  }
}
