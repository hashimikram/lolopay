...
public class ReportApiImpl extends ApiBase implements ReportApi {
   ...
   */
  public ReportApiImpl(MangoPayApi root) {
    super(root);
  }
  ...
  public ReportRequest create(String idempotencyKey, ReportRequest reportRequest) throws Exception {
    ...
    // ReportRequestTransport reportRequestTransport =
    // ReportRequestTransport.CreateFromBusinessObject(reportRequest);
    // return this.createObject(ReportRequestTransport.class, idempotencyKey,
    // "MethodKey.ReportRequest", reportRequestTransport,
    // reportRequestTransport.ReportType.ToString()).GetBusinessObject();
  ...
  @Override
  public List<ReportRequest> getAll(Pagination pagination, FilterReportsList filters, Sorting sort)
      throws Exception {
    if (filters == null) filters = new FilterReportsList();

    List<ReportRequest> result =
        this.getList(
            ReportRequest[].class,
            ReportRequest.class,
            "reports_get_all",
