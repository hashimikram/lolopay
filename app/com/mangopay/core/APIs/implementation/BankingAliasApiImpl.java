...
public class BankingAliasApiImpl extends ApiBase implements BankingAliasApi {
  ...
  @Override
  public BankingAlias create(String idempotencyKey, String walletId, BankingAlias bankingAlias)
      throws Exception {
    return this.createObject(
        BankingAlias.class, idempotencyKey, "banking_alias_create_iban", bankingAlias, walletId);
  }
  ...
  @Override
  public List<BankingAlias> listForWallet(
      String walletId, Pagination pagination, FilterBankingAlias filter, Sorting sorting)
      throws Exception {
    return this.getList(
        BankingAlias[].class,
        BankingAlias.class,
  ...
  @Override
  public List<BankingAlias> listForWallet(
      String walletId, Pagination pagination, FilterBankingAlias filter) throws Exception {
  ...
  @Override
  public BankingAlias deactivate(String bankingAliasId, BankingAlias bankingAlias)
      throws Exception {
    return this.updateObject(
        BankingAlias.class, "banking_alias_deactivate", bankingAlias, bankingAliasId);
  }
}
