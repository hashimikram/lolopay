...
public class TransferApiImpl extends ApiBase implements TransferApi {
   ...
   */
  public TransferApiImpl(MangoPayApi root) {
    super(root);
  }
  ...
  @Override
  public Refund createRefund(String idempotencyKey, String transferId, Refund refund)
      throws Exception {
    return this.createObject(
        Refund.class, idempotencyKey, "transfers_createrefunds", refund, transferId);
  }
  ...
  @Override
  public List<Refund> getRefunds(String transferId, Pagination pagination, Sorting sorting)
      throws Exception {
    return this.getList(
        Refund[].class, Refund.class, "transfers_getrefunds", pagination, transferId, sorting);
  }
}
