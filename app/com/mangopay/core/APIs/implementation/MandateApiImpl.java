...
public class MandateApiImpl extends ApiBase implements MandateApi {
  ...
  @Override
  public List<Mandate> getAll(FilterMandates filters, Pagination pagination, Sorting sorting)
      throws Exception {
  ...
  @Override
  public List<Mandate> getForUser(
      String userId, FilterMandates filters, Pagination pagination, Sorting sorting)
      throws Exception {
    if (filters == null) filters = new FilterMandates();
  ...
  @Override
  public List<Mandate> getForBankAccount(
      String userId,
  ...
  @Override
  public List<Transfer> getTransfers(String mandateId, Pagination pagination, Sorting sorting)
      throws Exception {
    return this.getList(
        Transfer[].class,
        Transfer.class,
