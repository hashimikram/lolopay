...
public class UboDeclarationApiImpl extends ApiBase implements UboDeclarationApi {
  ...
  @Override
  public List<UboDeclaration> getAll(String userId, Pagination pagination, Sorting sort)
      throws Exception {
    return this.getList(
        UboDeclaration[].class,
        UboDeclaration.class,
        "ubo_declaration_all",
        pagination,
        userId,
  ...
  @Override
  public UboDeclaration submitForValidation(String userId, String uboDeclarationId)
      throws Exception {
    ...
    return this.updateObject(
        UboDeclaration.class, "ubo_declaration_submit", uboDeclaration, userId);
  }
}
