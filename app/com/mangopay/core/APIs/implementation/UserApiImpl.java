...
public class UserApiImpl extends ApiBase implements UserApi {
  ...
  public User create(String idempotencyKey, User user) throws Exception {
    ...
    if (user instanceof UserNatural)
      response =
          this.createObject(
              UserNatural.class, idempotencyKey, "users_createnaturals", (UserNatural) user);
    else if (user instanceof UserLegal)
      response =
          this.createObject(
              UserLegal.class, idempotencyKey, "users_createlegals", (UserLegal) user);
    else throw new Exception("Unsupported user entity type.");
  ...
  public User update(User user) throws Exception {
    ...
    String methodKey = "";
    if (user instanceof UserNatural) methodKey = "users_savenaturals";
    else if (user instanceof UserLegal) methodKey = "users_savelegals";
    else throw new Exception("Unsupported user entity type.");
  ...
  public BankAccount createBankAccount(
      String idempotencyKey, String userId, BankAccount bankAccount) throws Exception {
    String type = this.getBankAccountType(bankAccount);
    return this.createObject(
        BankAccount.class, idempotencyKey, "users_createbankaccounts_" + type, bankAccount, userId);
  }

  @Override
  public BankAccount updateBankAccount(String userId, BankAccount bankAccount, String bankAccountId)
      throws Exception {
    return this.updateObject(
        BankAccount.class, "users_savebankaccount", bankAccount, userId, bankAccountId);
  }

  @Override
  public List<BankAccount> getBankAccounts(String userId, Pagination pagination, Sorting sorting)
      throws Exception {
    return this.getList(
        BankAccount[].class,
        BankAccount.class,
  ...
  @Override
  public List<Transaction> getBankAccountTransactions(
      String bankAccountId, Pagination pagination, Sorting sorting) throws Exception {
    return this.getList(
        Transaction[].class,
        Transaction.class,
  ...
  @Override
  public List<Wallet> getWallets(String userId, Pagination pagination, Sorting sorting)
      throws Exception {
    return this.getList(
        Wallet[].class, Wallet.class, "users_allwallets", pagination, userId, sorting);
  }
  ...
  public List<Transaction> getTransactions(
      String userId, Pagination pagination, FilterTransactions filter, Sorting sorting)
      throws Exception {
    return this.getList(
        Transaction[].class,
        Transaction.class,
  ...
  @Override
  public List<Card> getCards(String userId, Pagination pagination, Sorting sorting)
      throws Exception {
  ...
  @Override
  public void createKycPage(
      String idempotencyKey, String userId, String kycDocumentId, byte[] binaryData)
      throws Exception {
    ...
    this.createObject(
        KycPage.class, idempotencyKey, "kyc_page_create", kycPage, userId, kycDocumentId);
  }
  ...
  @Override
  public void createKycPage(
      String idempotencyKey, String userId, String kycDocumentId, String filePath)
      throws Exception {
    byte[] fileArray;
    Path path = Paths.get(filePath);
    fileArray = Files.readAllBytes(path);
  ...
  @Override
  public KycDocument createKycDocument(String idempotencyKey, String userId, KycDocumentType type)
      throws Exception {
    KycDocument kycDocument = new KycDocument();
    kycDocument.setType(type);

    return this.createObject(
        KycDocument.class, idempotencyKey, "users_createkycdocument", kycDocument, userId);
  }
  ...
  @Override
  public List<KycDocument> getKycDocuments(String userId, Pagination pagination, Sorting sorting)
      throws Exception {
    return this.getList(
        KycDocument[].class,
        KycDocument.class,
  ...
  private String getBankAccountType(BankAccount bankAccount) throws Exception {
    ...
    if (bankAccount.getDetails() == null) throw new Exception("Details is not defined.");

    String className =
        bankAccount.getDetails().getClass().getSimpleName().replace("BankAccountDetails", "");
  ...
  public EMoney getEMoney(String userId, String year, String month) throws Exception {
    if (userId == null || year == null || month == null) {
      throw new Exception(
          "Cannot get EMoney without specifying the userId or the year or the month");
    }
  ...
  public EMoney getEMoney(String userId, String year, CurrencyIso currencyIso) throws Exception {
    ...
    return this.getObject(
        EMoney.class, "users_emoney_year_currency", userId, year, currencyIso.name());
  }

  public EMoney getEMoney(String userId, String year, String month, CurrencyIso currencyIso)
      throws Exception {
    if (currencyIso == null) {
      return this.getEMoney(userId, year, month);
    }
    return this.getObject(
        EMoney.class, "users_emoney_month_currency", userId, year, month, currencyIso.name());
  }

  @Override
  public List<CardPreAuthorization> getPreAuthorizations(String userId) throws Exception {
    return this.getList(
        CardPreAuthorization[].class,
        CardPreAuthorization.class,
