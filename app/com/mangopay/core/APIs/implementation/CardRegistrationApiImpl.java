...
public class CardRegistrationApiImpl extends ApiBase implements CardRegistrationApi {
   ...
   */
  public CardRegistrationApiImpl(MangoPayApi root) {
    super(root);
  }
  ...
  @Override
  public CardRegistration create(String idempotencyKey, CardRegistration cardRegistration)
      throws Exception {
    return this.createObject(
        CardRegistration.class, idempotencyKey, "cardregistration_create", cardRegistration);
  }
