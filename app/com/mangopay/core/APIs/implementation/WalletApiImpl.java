...
public class WalletApiImpl extends ApiBase implements WalletApi {
   ...
   */
  public WalletApiImpl(MangoPayApi root) {
    super(root);
  }
  ...
  public List<Transaction> getTransactions(
      String walletId, Pagination pagination, FilterTransactions filter, Sorting sorting)
      throws Exception {
    return this.getList(
        Transaction[].class,
        Transaction.class,
  ...
  @Override
  public List<Transaction> getTransactions(
      String walletId, Pagination pagination, FilterTransactions filter) throws Exception {
