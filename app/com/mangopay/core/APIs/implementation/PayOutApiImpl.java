...
public class PayOutApiImpl extends ApiBase implements PayOutApi {
  ...
  public PayOut create(String idempotencyKey, PayOut payOut) throws Exception {
    ...
    return this.createObject(
        PayOut.class, idempotencyKey, String.format("payouts_%s_create", paymentKey), payOut);
  }
  ...
  @Override
  public List<Refund> getRefunds(String payOutId, Pagination pagination, Sorting sorting)
      throws Exception {
    return this.getList(
        Refund[].class, Refund.class, "payouts_get_refunds", pagination, payOutId, sorting);
  }
  ...
  private String getPaymentKey(PayOut payOut) throws Exception {
    ...
    String className =
        payOut
            .getMeanOfPaymentDetails()
            .getClass()
            .getSimpleName()
            .replace("PayOutPaymentDetails", "");
