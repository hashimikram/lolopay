...
public interface UserApi {
   ...
   * @throws Exception
   */
  BankAccount createBankAccount(String idempotencyKey, String userId, BankAccount bankAccount)
      throws Exception;
   ...
   * @throws Exception
   */
  BankAccount updateBankAccount(String userId, BankAccount bankAccount, String bankAccountId)
      throws Exception;
   ...
   * @throws Exception
   */
  List<BankAccount> getBankAccounts(String userId, Pagination pagination, Sorting sorting)
      throws Exception;
   ...
   * @throws Exception
   */
  List<Transaction> getBankAccountTransactions(
   ...
   * @throws Exception
   */
  void createKycPage(String idempotencyKey, String userId, String kycDocumentId, byte[] binaryData)
      throws Exception;
   ...
   * @throws Exception
   */
  void createKycPage(String idempotencyKey, String userId, String kycDocumentId, String filePath)
      throws Exception;
   ...
   * @throws Exception
   */
  KycDocument createKycDocument(String idempotencyKey, String userId, KycDocumentType type)
      throws Exception;
   ...
   * @throws Exception
   */
  List<KycDocument> getKycDocuments(String userId, Pagination pagination, Sorting sorting)
      throws Exception;

  /**
   * Shows the e-money cash-in/cash-out amounts for a particular user. Result will be in <code>EUR
   * </code> due to lack of a specified currency.
   *
  ...
  /**
   * Shows the e-money cash-in/cash-out amounts for a particular user. The Currency parameter can be
   * used to have the amounts specified in a certain currency.
   *
   * @param userId Id of the user whose e-money data to get.
   * @param year The year for which we want to get the e-money data.
   * @param currencyIso Currency in which to format money amounts. If <code>null</code>, will be
   *     considered as <code>EUR</code>.
   * @return EMoney data for the specified user.
   * @throws Exception
   */
   ...
   * @throws Exception
   */
  EMoney getEMoney(String userId, String year, String month, CurrencyIso currencyIso)
      throws Exception;
