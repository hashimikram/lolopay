...
public class CreateTests extends WithCustomApplication {
  ...
  private static String uri = routes.WalletController.create().url();

  @BeforeClass
  public static void init() {
    httpHelper = new HttpHelper("Wallet", "CreateTests");
  }
  ...
  @Test
  public void test002_CreateTests_ProviderError() throws Exception {
  ...
  @Test
  public void test003_CreateTests_Success() throws Exception {
    ...
    wallet = Json.fromJson(jsonResponse.get("body").get("wallet"), Wallet.class);
  ...
  @Test
  public void test004_CreateTests_UserIdInvalid() throws Exception {
    ...
    Map<String, String> parameters = new HashMap<String, String>();
    parameters.put("userId", "5e2fad@.njsd");
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_USER_ID_INVALID, error.getErrorDescription());
  }

  @Test
  public void test005_CreateTests_DescriptionRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_DESCRIPTION_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test006_CreateTests_DescriptionInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_DESCRIPTION_INVALID, error.getErrorDescription());
  }

  @Test
  public void test007_CreateTests_CurrencyRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_CURRENCY_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test008_CreateTests_CurrencyInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_CURRENCY_INVALID, error.getErrorDescription());
  }

  @Test
  public void test009_CreateTests_UserIdInexistentUser() throws Exception {
    ...
    Map<String, String> parameters = new HashMap<String, String>();
    parameters.put("userId", "5e37dcf38416412a25c6a1aa");
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_CREATEWALLET_USER_ID_INEXISTENT_USER, error.getErrorDescription());
  }

  @Test
  public void test010_CreateTests_DuplicatedWallet() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_DUPLICATED_WALLET, error.getErrorDescription());
  }

  @Test
  public void test011_CreateTests_UserIdRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_CREATEWALLET_USER_ID_REQUIRED, error.getErrorDescription());
  }
