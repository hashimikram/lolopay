...
public class TransactionsNoFeesTests extends WithCustomApplication {
  ...
  public static void init() {
    httpHelper = new HttpHelper("Wallet", "TransactionsNoFeesTests");
  }
  ...
  public void test002_CreateWallet() throws Exception {
    ...
    uri = routes.WalletController.transactionsNoFees(wallet.getId(), 1, 10, null).url();
  }

  @Test
  public void test003_TransactionsNoFeesTests_Success() throws Exception {
  ...
  @Test
  public void test004_TransactionsNoFeesTests_WalletIdInvalid() throws Exception {
    ...
    String uri =
        routes.WalletController.transactionsNoFees("5e37e45dbcbc012d4638aa@a", 1, 10, null).url();
    ...
    assertEquals(
        ErrorMessage.ERROR_GETWALLETTRANSACTIONS_WALLETID_INVALID, error.getErrorDescription());
  }

  @Test
  public void test005_TransactionsNoFeesTests_InexistentWallet() throws Exception {
    ...
    String uri =
        routes.WalletController.transactionsNoFees("5e37e45dbcbc012d4638aaaa", 1, 10, null).url();
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_GETWALLETTRANSACTIONS_INEXISTENT_WALLET, error.getErrorDescription());
  }

  /* No validation for sort param */
  @Test
  public void test006_TransactionsNoFeesTests_WithSort() throws Exception {
    ...
    String uri =
        routes.WalletController.transactionsNoFees(wallet.getId(), 1, 10, "nature:desc").url();
