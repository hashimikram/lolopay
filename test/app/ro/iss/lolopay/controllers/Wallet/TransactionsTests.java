...
public class TransactionsTests extends WithCustomApplication {
  ...
  public static void init() {
    httpHelper = new HttpHelper("Wallet", "TransactionsTests");
  }
  ...
  public void test002_CreateWallet() throws Exception {
    ...
    uri = routes.WalletController.transactions(wallet.getId(), 1, 10).url();
  }

  @Test
  public void test003_TransactionsTests_Success() throws Exception {
  ...
  @Test
  public void test004_TransactionsTests_WalletIdInvalid() throws Exception {
    ...
    String uri = routes.WalletController.transactions("5e37e45dbcbc012d4638aa@a", 1, 10).url();
  ...
  @Test
  public void test005_TransactionsTests_InexistentWallet() throws Exception {
    ...
    String uri = routes.WalletController.transactions("5e37e45dbcbc012d4638aaaa", 1, 10).url();
