...
public class GetAllDocumentsTests extends WithCustomApplication {

  private static String userId;
  private static String providerId;
  private static String documentId1;
  private static String documentId2;
  ...
  private static String uri = routes.DocumentController.getAllDocuments(1, 10).url();

  @BeforeClass
  public static void init() {
    httpHelper = new HttpHelper("Document", "GetAllDocumentsTests");
  }
  ...
  public void test002_CreateDocument() throws Exception {
    ...
    documentId1 = jsonResponse.get("body").get("document").get("id").asText();

    assertTrue(responseSuccess);
  }

  @Test
  public void test003_CreateDocument() throws Exception {
    ...
    documentId2 = jsonResponse.get("body").get("document").get("id").asText();

    assertTrue(responseSuccess);
  }

  @Test
  public void test004GetAllDocumentsTests_Success() throws Exception {
    // set variables for mock server response
    testName = httpHelper.getMethodName();
    ...
    List<Document> documents =
        Json.mapper()
            .readValue(
                jsonResponse.at("/body/documents").traverse(),
  ...
  public static void cleanDatabaseAfterAllTests() {
    ...
    datastoreTestAccount.delete(
        datastoreTestAccount.createQuery(Document.class).filter("id", documentId1));
    datastoreTestAccount.delete(
        datastoreTestAccount.createQuery(Document.class).filter("id", documentId2));
