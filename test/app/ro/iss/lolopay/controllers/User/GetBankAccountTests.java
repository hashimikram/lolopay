...
import static shared.ProviderApis.MANGO_GET_BANK_ACCOUNT;
...
public class GetBankAccountTests extends WithCustomApplication {
  ...
  public static void init() {
    httpHelper = new HttpHelper("User", "GetBankAccountTests");
  }
  ...
  private Router getRoutingDsl(BuiltInComponents components) {
    return RoutingDsl.fromComponents(components)
        ...
        .routingTo(req -> httpHelper.getProviderResponse(testName, MANGO, responseHttpStatus))
        .GET(String.format(MANGO_GET_BANK_ACCOUNT.getUri(), providerId))
        .routingTo(req -> httpHelper.getProviderResponse(testName, MANGO, responseHttpStatus))
        .build();
  }
  ...
  public void test002_CreateBankAccount() throws Exception {
    ...
    GetBankAccountTests.uri = routes.UserController.getBankAccount(userId, bankAccountId).url();
  }
  ...
  public void test004_GetBankAccountsTests_InvalidUserId() throws Exception {
    ...
    uri = routes.UserController.getBankAccount("asd@.asd", bankAccountId).url();
    ...
    assertEquals(ErrorMessage.ERROR_GETBANKACCOUNT_INVALID_USERID, error.getErrorDescription());
  }

  @Test
  public void test005_GetBankAccountsTests_InvalidBankAccountId() throws Exception {
    ...
    uri = routes.UserController.getBankAccount(userId, "asd@a.sd").url();
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_GETBANKACCOUNT_INVALID_BANKACCOUNTID, error.getErrorDescription());
  }
  ...
  public void test006_GetBankAccountsTests_InexistentUser() throws Exception {
    ...
    uri = routes.UserController.getBankAccount("5e39871bb4e4815ef27c1aaa", bankAccountId).url();
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_GETBANKACCOUNT_INEXISTENT_USER, error.getErrorDescription());
  }

  @Test
  public void test007_GetBankAccountsTests_InexistentBankAccount() throws Exception {
    ...
    uri = routes.UserController.getBankAccount(userId, "5e39871bb4e4815ef27c1aaa").url();
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_GETBANKACCOUNT_INEXISTENT_BANKACCOUNT, error.getErrorDescription());
  }
