...
public class CreateIbanTests extends WithCustomApplication {

  private static String userId;
  private static String providerId;
  private static String bankAccountId;
  private static String bankAccountId2;
  ...
  private static String uri = routes.BankAccountController.createIban().url();

  @BeforeClass
  public static void init() {
    httpHelper = new HttpHelper("BankAccount", "CreateIbanTests");
  }
  ...
  public void test001_CreateNaturalUser() throws Exception {
    ...
    System.out.println("CreateIbanTests - userId=" + userId);
    System.out.println("CreateIbanTests - user providerId=" + providerId);
  }

  /** Create account when there is no user */
  @Test
  public void test002_CreateIban_NoUser() throws Exception {
  ...
  /** Create IBAN account with valid data (valid IBAN and valid BIC (SWIFT code) ) */
  @Test
  public void test003_CreateIban_SuccessCase() throws Exception {
    ...
    System.out.println("CreateIbanTests - bankAccountId = " + bankAccountId);
  }

  /** Create IBAN account with valid data (valid IBAN but without any BIC value in input ) */
  @Test
  public void test004_CreateIban_SuccessCaseWithoutBic() throws Exception {
    ...
    // fill some variables
    bankAccountId2 = bankAccount.getId().toString();
    System.out.println("CreateIbanTests - bankAccountId2 = " + bankAccountId2);
  }

  /** Create IBAN account with provider error response */
  @Test
  public void test005_CreateIban_ProviderFailureCase() throws Exception {
  ...
  /** Create IBAN account with missing IBAN field */
  @Test
  public void test006_CreateIban_IbanRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertEquals(
        ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_IBAN_REQUIRED, error.getErrorDescription());
  }

  /** Create IBAN account with invalid IBAN field */
  @Test
  public void test007_CreateIban_IbanInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertEquals(
        ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_IBAN_INVALID, error.getErrorDescription());
  }

  /** Create IBAN account with long BIC field */
  @Test
  public void test008_CreateIban_BicMaxLength() throws Exception {
    ...
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_BIC_INVALID);
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_BIC_MAXLENGTH);
  ...
  /** Create IBAN account with short BIC field */
  @Test
  public void test009_CreateIban_BicMinLength() throws Exception {
    ...
    List<String> errors = new ArrayList<>();
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_BIC_INVALID);
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_BIC_MINLENGTH);
  ...
  /** Create IBAN account with invalid BIC field */
  @Test
  public void test010_CreateIban_BicInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertEquals(
        ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_BIC_INVALID, error.getErrorDescription());
  }

  /** Create account with long customTag field */
  @Test
  public void test011_CreateIban_CustomTagMaxLength() throws Exception {
  ...
  @Test
  public void test012_CreateIban_UserIdRequired() throws Exception {
  ...
  @Test
  public void test013_CreateIban_UserIdInvalid() throws Exception {
  ...
  @Test
  public void test014_CreateIban_OwnerNameRequired() throws Exception {
  ...
  @Test
  public void test015_CreateIban_OwnerNameMaxLength() throws Exception {
  ...
  @Test
  public void test016_CreateIban_OwnerAddressRequired() throws Exception {
  ...
  @Test
  public void test017_CreateIban_OwnerAddressAddressLine1Required() throws Exception {
  ...
  @Test
  public void test018_CreateIban_OwnerAddressAddressLine1MaxLength() throws Exception {
  ...
  @Test
  public void test019_CreateIban_OwnerAddressAddressLine2MaxLength() throws Exception {
  ...
  @Test
  public void test020_CreateIban_OwnerAddressCityRequired() throws Exception {
  ...
  @Test
  public void test021_CreateIban_OwnerAddressCityMaxLength() throws Exception {
  ...
  @Test
  public void test022_CreateIban_OwnerAddressCountryRequired() throws Exception {
  ...
  @Test
  public void test023_CreateIban_OwnerAddressCountryInvalid() throws Exception {
  ...
  @Test
  public void test024_CreateIban_OwnerAddressCountyRequired() throws Exception {
  ...
  @Test
  public void test025_CreateIban_OwnerAddressCountyMaxLength() throws Exception {
  ...
  @Test
  public void test026_CreateIban_OwnerAddressPostalCodeRequired() throws Exception {
  ...
  @Test
  public void test027_CreateIban_OwnerAddressPostalCodeMaxLength() throws Exception {
  ...
  /** Create IBAN account with missing all required fields */
  @Test
  public void test028_CreateIban_AllRequired() throws Exception {
    ...
    // construct expected list of errors
    List<String> errors = new ArrayList<>();
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_IBAN_REQUIRED);
    ...
    assertEquals(false, responseSuccess);
    assertEquals(0, errors.size());
    assertEquals(4, responseErrors.length);
  }

  /** Create IBAN account with missing all required fields, from address also */
  @Test
  public void test029_CreateIban_AllRequiredAddress() throws Exception {
  ...
  /** Create IBAN account with invalid and long fields */
  @Test
  public void test030_CreateIban_AllInvalidMaxLength() throws Exception {
    ...
    // construct expected list of errors
    List<String> errors = new ArrayList<>();
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_IBAN_INVALID);
    errors.add(ErrorMessage.ERROR_CREATEBANKACCOUNT_IBAN_BIC_INVALID);
  ...
  public static void cleanDatabaseAfterAllTests() {
    ...
    datastoreTestAccount.delete(
        datastoreTestAccount.createQuery(BankAccount.class).filter("id", bankAccountId2));
