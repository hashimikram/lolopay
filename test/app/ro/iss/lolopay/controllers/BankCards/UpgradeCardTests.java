...
import static shared.ProviderApis.PFS_UPGRADE_CARD;
...
public class UpgradeCardTests extends WithCustomApplication {
  ...
  private static String uri = routes.BankCardsController.upgradeCard().url();

  @BeforeClass
  public static void init() {
    httpHelper = new HttpHelper("BankCards", "UpgradeCardTests");
  }
  ...
  /** Upgrade card with invalid status */
  @Test
  public void test003_UpgradeCard_InvalidStatus() throws Exception {
    ...
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_CARD_INVALID_STATUS, error.getErrorDescription());
  }

  @Test
  public void test004_ChangeStatus() throws Exception {
  ...
  @Test
  public void test005_UpgradeCard_InvalidCard() throws Exception {
    ...
    Map<String, String> parameters = new HashMap<String, String>();
    parameters.put("cardId", "5e2ff156ad92c19128540aaa");
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_UPGRADEBANKCARD_INEXISTENT_CARD, error.getErrorDescription());
  }

  @Test
  public void test006_UpgradeCard_Success() throws Exception {
  ...
  @Test
  public void test007_UpgradeCard_CardNotVirtual() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_UPGRADEBANKCARD_CARD_NOT_VIRTUAL, error.getErrorDescription());
  }

  @Test
  public void test008_UpgradeCard_CardRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_UPGRADEBANKCARD_CARDID_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test009_UpgradeCard_CardValid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_UPGRADEBANKCARD_CARDID_INVALID, error.getErrorDescription());
  }

  @Test
  public void test010_UpgradeCard_AddressRequired() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_LINE1_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test011_UpgradeCard_AddressMaxLength() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_LINE1_MAXLENGTH, error.getErrorDescription());
  }

  @Test
  public void test012_UpgradeCard_CityRequired() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_CITY_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test013_UpgradeCard_CityMaxLength() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_CITY_MAXLENGTH, error.getErrorDescription());
  }

  @Test
  public void test014_UpgradeCard_CountyMaxLength() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_COUNTY_MAXLENGTH, error.getErrorDescription());
  }

  @Test
  public void test015_UpgradeCard_ZipRequired() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_POSTALCODE_REQUIRED,
        error.getErrorDescription());
  }

  @Test
  public void test016_UpgradeCard_ZipMaxLength() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_POSTALCODE_MAXLENGTH,
        error.getErrorDescription());
  }

  @Test
  public void test017_UpgradeCard_CountryRequired() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_COUNTRY_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test018_UpgradeCard_CountryValid() throws Exception {
    ...
    assertNotNull(jsonErrors);
    assertEquals(
        ErrorMessage.ERROR_UPGRADEBANKCARD_ADDRESS_COUNTRY_INVALID, error.getErrorDescription());
  }
