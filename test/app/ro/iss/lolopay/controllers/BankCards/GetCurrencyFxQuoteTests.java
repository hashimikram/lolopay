...
import static shared.ProviderApis.PFS_GET_FX_QUOTE;
...
public class GetCurrencyFxQuoteTests extends WithCustomApplication {
  ...
  private static String uri = routes.BankCardsController.getCurrencyFxQuote().url();

  @BeforeClass
  public static void init() {
    httpHelper = new HttpHelper("BankCards", "GetCurrencyFxQuoteTests");
  }
  ...
  @Test
  public void test003_GetCurrencyFxQuoteTests_CardNotFound() throws Exception {
    ...
    assertEquals(ErrorMessage.ERROR_FXQUOTE_INEXISTENT_CARD, error.getErrorDescription());
  }

  @Test
  public void test004_GetCurrencyFxQuoteTests_CardRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_CARDID_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test005_GetCurrencyFxQuoteTests_CardInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_CARDID_INVALID, error.getErrorDescription());
  }

  @Test
  public void test006_GetCurrencyFxQuoteTests_CurrencyFromRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_CURRENCYFROM_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test007_GetCurrencyFxQuoteTests_CurrencyFromInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_CURRENCYFROM_INVALID, error.getErrorDescription());
  }

  @Test
  public void test008_GetCurrencyFxQuoteTests_CurrencyToRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_CURRENCYTO_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test009_GetCurrencyFxQuoteTests_CurrencyToInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_CURRENCYTO_INVALID, error.getErrorDescription());
  }

  @Test
  public void test010_GetCurrencyFxQuoteTests_AmountRequired() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_AMOUNT_REQUIRED, error.getErrorDescription());
  }

  @Test
  public void test011_GetCurrencyFxQuoteTests_AmountInvalid() throws Exception {
    ...
    assertEquals(false, responseSuccess);
    assertNotNull(jsonErrors);
    assertEquals(ErrorMessage.ERROR_FXQUOTE_AMOUNT_INVALID, error.getErrorDescription());
  }

  @Test
  public void test012_GetCurrencyFxQuoteTests_Success() throws Exception {
  ...
  @Test
  public void test013_GetCurrencyFxQuoteTests_ProviderError() throws Exception {
