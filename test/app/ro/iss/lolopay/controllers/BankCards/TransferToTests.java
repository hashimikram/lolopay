...
public class TransferToTests extends WithCustomApplication {
  ...
  private static String uri = routes.BankCardsController.transferTo().url();

  @BeforeClass
  public static void init() {
    httpHelper = new HttpHelper("BankCards", "TransferToTests");
  }
  ...
  public void test002_CreateCard() throws Exception {
    ...
    bankCard = datastoreTestAccount.find(BankCard.class).filter("id", bankCardId).get();
  ...
  @Test
  public void test003_TransferToTests_SuccessCase() throws Exception {
  ...
  @Test
  public void test004_TransferToTests_CardIdRequired() throws Exception {
  ...
  @Test
  public void test005_TransferToTests_CurrencyRequired() throws Exception {
  ...
  @Test
  public void test006_TransferToTests_AmountRequired() throws Exception {
  ...
  @Test
  public void test007_TransferToTests_CardIdInvalid() throws Exception {
  ...
  @Test
  public void test008_TransferToTests_AmountInvalid() throws Exception {
  ...
  @Test
  public void test009_TransferToTests_InexistentCard() throws Exception {
  ...
  @Test
  public void test010_TransferToTests_CurrencyInvalid() throws Exception {
  ...
  @Test
  public void test011_TransferToTests_InexistentWalltetCurrency() throws Exception {
  ...
  @Test
  public void test011_TransferToTests_ProviderError() throws Exception {
  ...
  @Test
  public void test013_TransferToTests_CardInvalidStatus() throws Exception {
